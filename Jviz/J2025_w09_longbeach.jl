...
# ╔═╡ 34c4ddbc-1cdc-4713-a452-90d7fbb25bd4
begin
	using TidierFiles, TidierPlots, TidierData, TidierText
	using TidierCats, TidierDates, TidierStrings
	using Chain
	using CairoMakie
end

# ╔═╡ 1db2e571-7cf9-4abb-a26b-2eaa4f8df093
md"# Long Beach Animal Shelter
**Week 09-2025**
"

# ╔═╡ cdac9d80-4cec-11f0-397d-c53eb3397242
pwd()

# ╔═╡ c0a90257-4dea-4524-b53f-30a711aa28cb
md"**Data**"

# ╔═╡ 4c704cd5-e217-4999-a4e9-af16b9033629
begin
	url_main = "https://raw.githubusercontent.com/rfordatascience/tidytuesday/main/"
	url_data = "data/2025/2025-03-04/longbeach.csv"
	pets = read_csv(url_main*url_data);
end;

# ╔═╡ 070e9357-70f6-438d-bb3e-a73c103b7ca7
first(pets, 4)

# ╔═╡ 1e3ed8a8-71e5-413f-8ba3-31218ac81ed7
md"## Viz"

# ╔═╡ 6bc3b9f5-4f69-4a2d-8d12-f741af4c3074
dfc = @chain pets begin
	@mutate(animal_type_cat = categorical(animal_type))
	@mutate(animal_type_cat = cat_rev(cat_infreq(animal_type_cat)))
end;

# ╔═╡ 61a92178-1946-4dad-8c3a-123b093efd81
ggplot(dfc, @aes(y = animal_type_cat)) + 
	geom_bar() +
   theme_minimal()

# ╔═╡ b1dad233-aee2-4856-96b7-dcf31e840cbd
...
manifest_format = "2.0"
project_hash = "e5e2b2ef7cc3c2f4cc2a45b201c6652ecc610522"
...
[[deps.ChunkCodecCore]]
git-tree-sha1 = "1667d15ab0285b4f8f4cfb8ea10ba2e48c6e32b4"
uuid = "0b6fb165-00bc-4d37-ab8b-79f91016dbe1"
version = "0.5.0"

[[deps.ChunkCodecLibBrotli]]
deps = ["ChunkCodecCore", "brotli_jll"]
git-tree-sha1 = "af76f3a42ef46fcb2942cd3c91c9c26f0ae3c01c"
uuid = "653b0ff7-85b5-4442-93c1-dcc330d3ec7d"
version = "0.2.0"

[[deps.ChunkCodecLibLz4]]
deps = ["ChunkCodecCore", "Lz4_jll"]
git-tree-sha1 = "ad4336c7daaea2e589ee2f03a7f4d45702516267"
uuid = "7e9cc85e-5614-42a3-ad86-b78f920b38a5"
version = "0.2.1"

[[deps.ChunkCodecLibSnappy]]
deps = ["ChunkCodecCore", "snappy_jll"]
git-tree-sha1 = "3014a20590582608bf4d4839cbbae5d0f2f600a5"
uuid = "eac87354-86d5-4a5b-ab5f-a6ee56b239b3"
version = "0.2.0"

[[deps.ChunkCodecLibZlib]]
deps = ["ChunkCodecCore", "Zlib_jll"]
git-tree-sha1 = "5ac2692623c9beb04e35292e2daf678d980c128d"
uuid = "4c0bbee4-addc-4d73-81a0-b6caacae83c8"
version = "0.2.0"

[[deps.ChunkCodecLibZstd]]
deps = ["ChunkCodecCore", "Zstd_jll"]
git-tree-sha1 = "e851a6d1a53b6246820c3ee49a703bd54e4a8ad5"
...
git-tree-sha1 = "3146f61d1f95f38f185c19b77e6e1aba9e4c0ab2"
...
git-tree-sha1 = "70ec79ef9c8058ca58c546ea462458885438ba4f"
...
git-tree-sha1 = "dba147540bc9f0778e816875b8f77b24236e9bc0"
